...
class consecutiveDistanceTest(unittest.TestCase):
    ...
    def testExampleInput1(self):
        listInput = [6, 11]
        expectedOutput = 0
        actualOutput = cs.calcuateConsecutiveNDist(listInput, 1)
    ...
    def testRatingWithDistOf2(self):
        listInput = [3, 9, 20, 11, 1, 7]
        expectedOutput = 10
        actualOutput = cs.calcuateConsecutiveNDist(listInput, 2)
